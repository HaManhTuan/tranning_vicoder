...
<div class="home-page-wrapper">
   <div class="container main_v2">
      <div class="product_new row">
         <div class="col-lg-9">
            <div class="box-title">
               <p class="p_title">Sản phẩm mới</p>
            </div>
            ...
            <nav class="paginate_pro">
               <ul class="pagination justify-content-end">
                  <li class="page-item disabled">
                     <a class="page-link ds-flex" href="#" tabindex="-1" aria-disabled="true">Đầu
                        <i class="fa fa-caret-left" aria-hidden="true" style="margin-left: 5px"></i>
                  ...
                  <li class="page-item active_pg"><a class="page-link" href="#">2</a></li>
                  ...
                  <li class="page-item">
                     <a class="page-link ds-flex" href="#">
                        <i class="fa fa-caret-right" aria-hidden="true"></i>
                        <i class="fa fa-caret-right" aria-hidden="true" style="margin-right: 5px"></i> Cuối</a>
                  </li>
               </ul>
            </nav>
         </div>
         ...
         <div class="col-lg-9">
            <div class="box-title" style="">
               <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-smm-6"><a href="/san-pham" class="link_all " style="float: right;">Xem tất cả</a></div>
               </div>
            </div>
            <div class="row cate_product">
               ...
               </div>     <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 product_item">
                  <div class="card item">
                     <a href="/chi-tiet">
                        <div class="card-img">
                           <img src="./frontend/images/background.png" class="card-img-top center cover" alt="" style=" background-image: url('../../frontend/images/K2241620_FXA.png');">
